...
expName = 'Task_THHS_swapped'  # from the Builder filename that created this script
...
#We changed "FALSE" to "TRUE" when shifting into fullscreen
...
for trial_num in range(len(Trial_dict)): #range(len(Trial_dict))
    ...
    if Trial_dict[trial_num]['cue']=='dpr' or Trial_dict[trial_num]['cue']=='dpb':
        if Trial_dict[trial_num]['pic']=='Face':
            ...
            corr_resp=no_key
    if Trial_dict[trial_num]['cue']=='fpr' or Trial_dict[trial_num]['cue']=='fcr':
        if Trial_dict[trial_num]['pic']=='Face':
            corr_resp=yes_key
        else:
            corr_resp=no_key
    if Trial_dict[trial_num]['cue']=='dcr' or Trial_dict[trial_num]['cue']=='dcb':
        if Trial_dict[trial_num]['pic']=='Scene':
            ...
            corr_resp=no_key
    if Trial_dict[trial_num]['cue']=='fpb' or Trial_dict[trial_num]['cue']=='fcb':
        if Trial_dict[trial_num]['pic']=='Scene':
            corr_resp=yes_key
        else:
            corr_resp=no_key
